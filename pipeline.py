...
with open ("SRR_accession_IDs.txt",'r') as infile: #read in the accession IDs
    ...
    for id in IDlist:
        os.system("bowtie2 --quiet -x index/HCMV -1 miniProject_Xufang_Deng/"+id+"_1.fastq"+" -2 miniProject_Xufang_Deng/"+id+"_2.fastq --al-conc miniProject_Xufang_Deng/results/"+id+"mapped.fq") #map reads to a reference
